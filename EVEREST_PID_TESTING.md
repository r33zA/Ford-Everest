...
Version: 2026-05-08 clean alignment pass  
Aligned default file: `signalsets/v3/default.json` / Everest default v0.6.0 connectables layout  
Vehicle: Ford Everest Trend MY25.25, Australian market, 2.0 L Bi-Turbo Diesel, 10-speed automatic, full-time 4WD

## Update focus

- Cleaned, linted, and restructured the testing log so it matches the current `default.json` layout.
- Promoted confirmed Ford wheel-speed and body-motion PIDs out of testing.
- Removed old `EVEREST_TEST_*` assumptions from the log language where they no longer match the current default file.
- Documented that `EVEREST_TEST_ENGINE_OIL_PRESSURE_7D-F_F45C_RAW` / `FORD_EOP` remains **archive only** and is not active.
- Recorded both Ford extended speed variants:
  - raw `22F40D`
  - corrected `22F40D + 4 km/h`
- Confirmed current connectable decisions:
  - raw and corrected speed can both be used as `speed`
  - wheel speeds are not `suggestedMetric`
  - engine oil temperature is `engineOilTemperature`
  - engine load is `engineLoad`
  - transmission gear engaged is `transmissionGear`

## Sanity-check snapshot

| Check                               | Result                       |
| ----------------------------------- | ---------------------------- |
| Commands in current default.json    | 60                           |
| Signals in current default.json     | 63                           |
| Signals with suggestedMetric        | 14                           |
| Remaining EVEREST_TEST_* signal IDs | 0                            |
...
| Engine       | 22F405     | 7E0→7E8 | Coolant temperature                   | Works                     | 47–56°C warm-up                         | Matched Pelican built-in ECT.                                  |
...
| Engine       | 2205FC     | 7E0→7E8 | Cylinder head temperature sensor 2    | Works / plausible         | Temperature trace plausible             | Useful secondary engine temp.                                  |
...
| Transmission | 221E16     | 7E1→7E9 | Input shaft speed ISS/TSS             | Works                     | ~10,000 rpm seen                        | Active; watch for scale sanity.                                |
| Emissions    | 22055D     | 7E0→7E8 | DPF soot load 055D div64              | Works / useful            | 100% when dash Exhaust Filter Full      | Useful, but still not fully proven as universal dash fullness. |
...
| Battery      | 22402B     | 726→72E | Battery current                       | Works / direction unclear | 3–5 A seen                              | Sign direction still needs confirming.                         |
...
This table is intentionally generated from the current parsed `default.json` so the log and JSON stay aligned.
...
| Battery              | EVEREST_BATTERY_SOC_4028_726                  | Aux 12V battery state of charge             | 224028 | 726→72E | len 8; raw; range ..100; percent                        | —                        |
| Battery              | EVEREST_AUX_12V_BATTERY_VOLTAGE_402A          | Aux 12V battery voltage                     | 22402A | 726→72E | len 8; val÷20+6; range ..18.75; volts                   | starterBatteryVoltage    |
| Battery              | EVEREST_BATTERY_AGE_SCALAR_4027               | Battery age scalar                          | 224027 | 726→72E | len 16; raw; range ..1825; scalar                       | —                        |
| Battery              | EVEREST_BATTERY_CHARGE_4028_DIV255            | Battery charge 4028 div255                  | 224028 | 726→72E | len 8; val×100÷255; range ..100; percent                | —                        |
| Body                 | EVEREST_GRILL_SHUTTER_DUTY_CYCLE_0707         | Grill shutter duty cycle                    | 220707 | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | —                        |
...
| Climate              | EVEREST_AC_REFRIGERANT_PRESSURE_0604          | A/C refrigerant pressure                    | 220604 | 7E0→7E8 | len 16; signed; raw; range -32768..32767; kilopascal    | —                        |
...
| Control              | EVEREST_ACCEL_PEDAL_032B                      | Accelerator pedal position                  | 22032B | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | —                        |
| DTCs                 | EVEREST_DISTANCE_SINCE_DTC_CLEAR_F431         | Distance since DTC clear                    | 22F431 | 7E0→7E8 | len 16; raw; range ..65535; kilometers                  | distanceSinceDTCsCleared |
| DTCs                 | EVEREST_DISTANCE_WITH_MIL_F421                | Distance with MIL                           | 22F421 | 7E0→7E8 | len 16; raw; range ..65535; kilometers                  | —                        |
| DTCs                 | EVEREST_WARMUPS_SINCE_DTC_CLEAR_F430          | Warm-ups since DTC clear                    | 22F430 | 7E0→7E8 | len 8; raw; range ..255; scalar                         | —                        |
...
| Emissions.EGR        | EVEREST_EGR_OPEN_052E                         | EGR open percentage                         | 22052E | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | —                        |
...
| Engine               | EVEREST_ENGINE_LOAD_F404                      | Engine load                                 | 22F404 | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | engineLoad               |
...
| Engine               | EVEREST_ENGINE_REFERENCE_TORQUE_F463          | Engine reference torque                     | 22F463 | 7E0→7E8 | len 16; raw; range ..65535; newtonMeters                | —                        |
| Engine               | EVEREST_ENGINE_RUN_TIME_F41F                  | Engine run time                             | 22F41F | 7E0→7E8 | len 16; raw; range ..65535; seconds                     | —                        |
...
| Engine               | EVEREST_IAT_FAULT_0700                        | Intake temperature fault                    | 220700 | 7E0→7E8 | len 8; raw; range ..255; scalar                         | —                        |
| Engine               | EVEREST_IAT_SENSOR_VOLTAGE_1279               | Intake temperature sensor voltage           | 221279 | 7E0→7E8 | len 16; val×5÷1023; range ..5; volts                    | —                        |
...
| Engine.Boost         | EVEREST_MANIFOLD_PRESSURE_F40B                | Manifold pressure                           | 22F40B | 7E0→7E8 | len 8; val×10000÷68947; range ..36; psi                 | —                        |
| Engine.Boost         | EVEREST_WASTEGATE_DUTY_CYCLE_0462             | Wastegate duty cycle                        | 220462 | 7E0→7E8 | len 16; val×100÷32768; range ..100; percent             | —                        |
| Engine.Boost.Generic | EVEREST_GENERIC_MAP_010B                      | Generic MAP                                 | 010B   | 7E0→7E8 | len 8; raw; range ..255; kilopascal                     | —                        |
...
| Fuel                 | EVEREST_LPFP_ACTUAL_0548                      | Fuel pressure, low actual                   | 220548 | 7E0→7E8 | len 16; signed; val×10000÷137892; range ..200; psi      | —                        |
| Fuel                 | EVEREST_LPFP_DESIRED_041F                     | Fuel pressure, low desired                  | 22041F | 7E0→7E8 | len 8; val×435÷1000; range ..110; psi                   | —                        |
| Fuel                 | EVEREST_FUEL_REMAINING_F42F                   | Fuel remaining                              | 22F42F | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | fuelTankLevel            |
...
| Fuel.Generic         | EVEREST_GENERIC_FUEL_LEVEL_012F               | Generic fuel level                          | 012F   | 7E0→7E8 | len 8; val×100÷255; range ..100; percent                | fuelTankLevel            |
| Maintenance          | EVEREST_OIL_LIFE_REMAINING_054B               | Oil life remaining                          | 22054B | 7E0→7E8 | len 8; raw; range ..100; percent                        | —                        |
...
| Movement             | EVEREST_SPEED_FORD_EXTENDED_F40D              | Vehicle speed Ford extended raw             | 22F40D | 7E0→7E8 | len 8; raw; range ..255; kilometersPerHour              | speed                    |
| Movement.BodyMotion  | FORD_LAT_G                                    | Lateral acceleration                        | 222B11 | 760→768 | len 16; signed; val÷50; range -1..1; scalar             | —                        |
| Movement.BodyMotion  | FORD_LAT_ANG                                  | Lateral angle                               | 222B0C | 760→768 | len 8; signed; raw; range -90..90; degrees              | —                        |
| Movement.WheelSpeed  | FORD_FL_VSS                                   | Front left wheel speed                      | 222B07 | 760→768 | len 8; raw; range ..200; kilometersPerHour              | —                        |
| Movement.WheelSpeed  | FORD_FR_VSS                                   | Front right wheel speed                     | 222B06 | 760→768 | len 8; raw; range ..200; kilometersPerHour              | —                        |
| Movement.WheelSpeed  | FORD_RL_VSS                                   | Rear left wheel speed                       | 222B09 | 760→768 | len 8; raw; range ..200; kilometersPerHour              | —                        |
| Movement.WheelSpeed  | FORD_RR_VSS                                   | Rear right wheel speed                      | 222B08 | 760→768 | len 8; raw; range ..200; kilometersPerHour              | —                        |
...
| Transmission         | EVEREST_TRANS_TEMP_1E1C_5_72                  | Transmission fluid temperature              | 221E1C | 7E1→7E9 | len 16; val×5÷72-17; range ..200; celsius               | —                        |
| Transmission         | EVEREST_GEAR_COMMANDED_7E1_1E12               | Transmission gear commanded                 | 221E12 | 7E1→7E9 | len 8; raw; range ..10; scalar                          | —                        |
| Transmission         | EVEREST_GEAR_ENGAGED_7E1_1E1F                 | Transmission gear engaged                   | 221E1F | 7E1→7E9 | len 8; raw; range ..10; scalar                          | transmissionGear         |
...
| 0111                      | 7E0→7E8 | Generic throttle position                 | Rejected               | Negative response / out of range.                                          |
...
| 6        | Fuel rail pressure actual                               | Partly found | Desired rail pressure and sensor voltage respond; true actual high-pressure rail still needs confirmation. |
| 7        | Factory TPMS tyre temperature                           | Low priority | Interesting only if factory sensors/modules expose it; Oricom TPMS is separate.                            |
...
- Confirmed working signals in the current v0.6.0 layout.
- Raw and corrected Ford extended vehicle speed.
- Ford ABS wheel speeds and body-motion signals, but **not** as `suggestedMetric`.
- Engine oil temperature, engine load, coolant temperature, RPM, DTE, fuel remaining, fuel rate, odometer, DPF soot load, transmission temp, transmission gear, and starter battery voltage connectables.
